...
class Styles {
  static const Color wewe = Color(0xFFF3E5F5);
...
class AppThemes {
  ...
  static final ThemeData beigeTheme = ThemeData(
    fontFamily: "Comfortaa",
    scaffoldBackgroundColor: const Color(0xFFF3E5F5), // Beige background
    textTheme: const TextTheme(
      bodyMedium: TextStyle(color: Colors.purple),
    ),
    colorScheme: ColorScheme.fromSwatch().copyWith(
      brightness: Brightness.light,
      primary: const Color(0xFF4F3466), // Beige
      secondary: const Color(0xFFF3E5F5) // Tan
    ),
  );
