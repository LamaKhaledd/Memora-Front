...
import 'package:memora/services/repositories/topic_repo.dart';
import 'package:memora/widgets/CustomModal.dart';
...
class _SubjectContainerState extends State<SubjectContainer> {
  ...
  Future<void> createTopic(String subjectId, String topicName) async {
    ...
    try {
      ...
      print("Error during createTopic: $error");
      showCustomDialog(
        context: context,
